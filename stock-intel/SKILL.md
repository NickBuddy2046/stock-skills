...
Market intelligence hub — screening, ranking, scanning, and thematic research via the stock data provider.
...
| User wants | Use |
|---|---|
| Raw K-line or quote data | `stock-market-data` |
| News / filings | `stock-content` |
| Institutional research | `stock-research` |
