...
| User asks for ...                                                             | Use                                                           |
| ----------------------------------------------------------------------------- | ------------------------------------------------------------- |
| Historical PE/PB percentile, "is X expensive vs its own history / industry?" | [`stock-fundamentals`](../longbridge-fundamentals)       |
| Financial-statement / KPI overview without an earnings framing                | [`stock-fundamentals`](../longbridge-fundamentals)       |
| Cross-symbol matrix, "X vs Y vs Z"                                            | [`stock-research`](../longbridge-research)               |
| Classified news + filings + community sentiment for a single name             | [`stock-content`](../longbridge-content)                 |
| Daily incremental briefing across the user's watchlist                        | [`stock-intel`](../longbridge-intel)                     |
| Live quote / valuation indices                                                | [`stock-market-data`](../longbridge-market-data)         |
