...
7. **Output** the candidate table sorted by composite score descending (see Output section). Cite stock data provider.
...
```
Factor Screen Results — Source: stock data provider
