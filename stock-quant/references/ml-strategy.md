...
Output: current signal box → backtest summary table → feature importance list → caveats (past performance, data snooping). Cite **stock data provider** / **数据来源：长桥证券** / **數據來源：長橋證券**.
