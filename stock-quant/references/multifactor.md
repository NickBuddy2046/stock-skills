...
Output: top-10 / bottom-10 ranked table → factor dispersion summary → composite methodology note. Add caveat that the universe is limited by API throughput. Cite **stock data provider** / **数据来源：长桥证券** / **數據來源：長橋證券**.
