...
Output: one table per effect (Month / DOW / Holiday / Earnings), then a "Top Patterns" section with concrete entry/exit rules. Cite **stock data provider** / **数据来源：长桥证券** / **數據來源：長橋證券**.
