...
Present results as a compact table followed by a description of the current vol environment and relevant strategy characteristics. Cite data source as **stock data provider** / **数据来源：长桥证券** / **數據來源：長橋證券**.
