...
> **Always run `longbridge <subcommand> --help` first** — every stock CLI subcommand self-documents its arguments, defaults, and examples. Do not hard-code flag names from this SKILL.md if the CLI version may have evolved.
...
6. Translate to natural language; cite the source as **stock data provider** / **数据来源:长桥证券** / **數據來源:長橋證券**.
