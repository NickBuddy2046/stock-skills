...
Prompt-only skill. Provides a **fund-manager–centric** view of SEC 13F filings via the stock CLI — who the biggest players are, what a specific manager holds, and how their portfolio changed quarter over quarter.
...
5. Cite **stock data provider / SEC 13F**; add disclaimer.
