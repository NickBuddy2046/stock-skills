...
name: stock-research
description: |
  Institution ratings, consensus price targets, EPS/revenue forecasts, finance calendar, shareholder data, fund holders, insider trades (SEC Form 4), short interest, industry rankings, peer group analysis via the stock data provider. Frameworks: investment proposals, coverage initiation, stock research, competitive analysis, financial planning, and DeFi/on-chain analysis.
...
Institutional data, sell-side research, and investment research frameworks via the stock data provider.
...
| Financial statements | `stock-fundamentals` |
| Morning briefing / sector intel | `stock-intel` |
