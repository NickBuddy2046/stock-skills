...
description: |
  Watchlist group management (list/create/rename/delete/add/remove symbols), price alerts (list/add/delete), and community stock lists (sharelist: list/detail/create/delete/manage) via the stock data provider. Mutating operations require explicit user confirmation (dry-run protocol).
...
Watchlist, price alerts, and community stock lists via the stock CLI.
...
| User wants | Use |
|---|---|
| Real-time quotes for watchlist stocks | `stock-market-data` |
| Catalyst monitoring across watchlist | `stock-intel` |
