...
Apply behavioral finance theory to identify exploitable market inefficiencies — map common cognitive biases to measurable price/volume patterns using stock data.
...
**Detect**: Use `stock-earnings` to identify beats. Track price drift with `longbridge kline --period day --count 60`.
...
2. Observable evidence from stock data (specific numbers).
