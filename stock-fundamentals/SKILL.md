...
description: |
  Financial statements, business segments, dividends, valuation multiples (PE/PB/PS), industry comparison, operating data, corporate actions, company and executive profiles, cross-stock comparison, and valuation ranking via the stock data provider. Also: DCF models, value investing screens (low PE/PB, margin of safety), and behavioral finance analysis frameworks.
...
Financial data, valuation, and company information for HK / US / A-share / Singapore via the stock data provider.
...
| User wants | Use |
|---|---|
| Analyst ratings / consensus | `stock-research` |
| Portfolio P&L / account | `stock-portfolio` |
