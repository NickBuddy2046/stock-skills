...
description: |
  Options chains, option quotes, option volume, Greeks (Delta/Gamma/Theta/Vega), implied volatility, and HK warrants (callable bull/bear, call/put warrants, issuer list) for HK/US markets via the stock data provider.
...
Options and warrants data for HK / US markets via the stock CLI.
...
| User wants | Use |
|---|---|
| Real-time underlying quote | `stock-market-data` |
| Quantitative volatility strategies (HV regime, straddle/condor) | `stock-quant` |
