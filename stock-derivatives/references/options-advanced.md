...
Prompt-only analysis skill. Covers advanced options and volatility strategies for experienced traders — calendar/diagonal spreads, dynamic delta hedging, vol arbitrage, and skew trading — grounded in live stock data.
...
- stock data supports manual calibration: extract IV smile from chain, fit SABR numerically.
...
```
{Symbol} advanced options analysis — Source: stock data provider
